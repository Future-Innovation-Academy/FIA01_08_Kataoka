...
const Component_EE_Form_BirthDay = () => {
    ...
    return (
        <div class="component-ee">
            ...
            <div class="component-ee-btn">
                <Button variant="outlined" onClick={() => navigate('/Component_EE_Form_Address')}>戻る</Button>    
                <Button variant="contained" onClick={() => navigate('/Component_EE_Form_Mail')}>次へ</Button>
            </div>
        </div>
    )
}
export default Component_EE_Form_BirthDay