...
const Component_ER_Form_IdPassword = () => {
      ...
      <div class="component-ee">
            <p>IDとパスワードを入力してください</p>
               ...
               <div class="component-ee-btn">
                  <Button variant="outlined" onClick={() => navigate('/Component_ER_Form_Tel')}>戻る</Button>    
                  <Button variant="contained" onClick={() => navigate('/Component_ER_Form_Sishu_Kknn')}>次へ</Button> 
               </div>
        </div>
    )
}
export default Component_ER_Form_IdPassword