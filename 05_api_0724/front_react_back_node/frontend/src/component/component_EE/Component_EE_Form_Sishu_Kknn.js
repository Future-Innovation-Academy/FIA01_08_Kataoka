...
const Component_EE_Form_Sishu_Kknn = () => {
       ...
       const clickSubmit = () => {
        ...
        axios.get(`/api/tork`, {
            params:{
                 ...
                 , mktk : localStorage.getItem('mktk')
            ...
            <p>登録内容をご確認下さい</p>
               <label class="contact-douki">
                <table class="ee-sishu-kknn-table">
                    ...
                    <tr>
                        <th>トレーニングの目的</th>
                        <td>{localStorage.getItem('mktk')}</td>
                    </tr>
                    <tr>
                        <th>メールアドレス</th>
               ...
               <div class="component-ee-btn">
                    <Button variant="outlined" onClick={() => navigate('/Component_EE_Form_IdPassword')}>戻る</Button>    
                    <Button type="submit" variant="contained" onClick={clickSubmit}>登録</Button>
                </div>
        </div>
    )
}
export default Component_EE_Form_Sishu_Kknn