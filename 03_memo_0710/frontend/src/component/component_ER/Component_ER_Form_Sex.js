    ...
    return (
        <div class="component-ee">
            ...
            <div class="component-ee-btn">
                <Button variant="outlined" onClick={() => navigate('/Component_ER_Form_Name')}>戻る</Button>    
                <Button variant="contained" onClick={() => navigate('/Component_ER_Form_Address')}>次へ</Button>
            </div>
        </div>
    )
}
export default Component_ER_Form_Sex